package com.example.charactermarkevalation
...
import com.example.charactermarkevalation.ui.theme.CharacterMarkEvalationTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkButton.setOnClickListener {
            ...
            if (grade == "A"){
                ...
                resultText.text = "Invalid Output"
            }
